...
class NewTaskScreen extends StatelessWidget {
  const NewTaskScreen({super.key, this.task, this.isEdit = false});
  ...
  Widget build(BuildContext context) {
    ...
    isEdit ? cubit.initalizeData(task!) : null;
    return PopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomSubmitButton(
          onPressed: () {
            isEdit ? cubit.updateTask() : cubit.addTask();
          },
          isEdit: isEdit,
        ),
      ),
