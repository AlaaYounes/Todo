...
class EntertainmentList extends StatelessWidget {
  const EntertainmentList({super.key, required this.cubit});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        CategoryWidget(
          remainingCount: cubit.entertainmentTasksList
        ...
        ListView.separated(
          ...
          itemCount: cubit.entertainmentTasksList.length,
          itemBuilder: (context, index) {
            final task = cubit.entertainmentTasksList[index];
            return TaskItemCard(
              task: task,
              onTap: () {
                Navigator.push(
